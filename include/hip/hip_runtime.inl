...
#else
{
  ...
  if (cudaError == cudaSuccess) {
    ...
    prop->cooperativeLaunch = cudaProp.cooperativeLaunch;
    prop->cooperativeLaunch = cudaProp.cooperativeLaunch;
    ...
    prop->kernelExecTimeoutEnabled = cudaProp.kernelExecTimeoutEnabled;
    prop->ECCEnabled = cudaProp.ECCEnabled;
    prop->tccDriver = cudaProp.tccDriver;
    prop->managedMemory = cudaProp.managedMemory;
    prop->directManagedMemAccessFromHost = cudaProp.directManagedMemAccessFromHost;
    prop->concurrentManagedAccess = cudaProp.concurrentManagedAccess;
    ...
    prop->hdpMemFlushCntl = nullptr;
    prop->hdpRegFlushCntl =nullptr;
    prop->cooperativeMultiDeviceUnmatchedFunc = 0;
    prop->cooperativeMultiDeviceUnmatchedGridDim = 0;
    prop->cooperativeMultiDeviceUnmatchedBlockDim = 0;
